from getResVars import *
from array import array

filename = "turbo_2015_data.root"
...
for leaf in tree:
	...
	tpl = getResVars(parent,lab_lamc,lab_p,lab_h1,lab_h2)

	Lambdac_sph1[0] = tpl[0]
	Lambdac_sh1h2[0] = tpl[1]
	Lambdac_sph2[0] = tpl[2]
	proton_LcRest_costheta[0] = tpl[3]
	proton_LcRest_cosphi[0] = tpl[4]
	Lambdac_LcRest_thetah1h2[0] = tpl[5]
