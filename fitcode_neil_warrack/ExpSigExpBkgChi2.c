...
void fitfunc() {
  ...
  TFile *datafile = TFile::Open("~/Documents/uni/LHCb_CharmSummerProj/learning_root/RooFit/firstTry/datafileLambda_TAUminNeg002_max005.root");
  RooDataSet* ds = (RooDataSet*)datafile->Get("ds") ;
  
  // DO THIS FIRST!!
  /*
  // Write .root dataset file from TTree  TFile *file_01 = TFile::Open("~/Documents/uni/LHCb_CharmSummerProj/data/turbo_2015_data.root");
  ...
  */
  ...
  ds->RooAbsData::getRange(Lambda_cplus_TAU, lowest, highest);
   ...
   RooRealVar nBkg("nBkg","nBkg", 10, 0, 1420336);
