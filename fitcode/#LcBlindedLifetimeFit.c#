...
RooUnblindOffset decayConstUnblind("decayConstUnblind", "Unblind decay rate", "someblindingstring", 0.5, decayConstBlind) ;
...
timePlot->Draw();
timePlot->GetYaxis()->SetTitleOffset(1.4);
canv.SaveAs("LcDecayTimeFit.png") ;
